...
type
  TForm3 = class(TForm)
    ...
    procedure ButtonAutenticarClick(Sender: TObject);
  private
    { Private declarations }
    const
      DB_PESSOA = 'DB-Pessoa.json';
      BASE_PATH = 'C:\Users\Gustavo Mena Barreto\OneDrive\Área de Trabalho\Multi-Tier\';
      BASE_PATH_ARQUIVOS = 'C:\Users\Gustavo Mena Barreto\OneDrive\Área de Trabalho\Multi-Tier\Imagens\';
  public
    { Public declarations }
  end;
...
//  Showmessage(Objeto.GetValue('block_hash').Value);
  ...
  MemoResultado.Clear;
  //retorna o nome do field e o valor
  MemoResultado.Lines.Add(objeto.Get('block_hash').ToString);
  //retorna apena o valor do field
...
procedure TForm3.ButtonAutenticarClick(Sender: TObject);
begin
  MemoRespostaHash.Lines.Insert(
    0,
    ClientModule1.ServerMethods1Client.AutenticaUsuario(THashSHA2.GetHashString(EditSenha.text+'Turma 2024')));
end;
