...
begin
 TMessage.ShowMessage('O Leão está se alimentado');
end;

procedure TLeao.Dormir;
begin
  TMessage.ShowMessage('O Leão está dormindo');
end;
...
begin
   TMessage.ShowMessage('O Leão está andando');
end;

function TLeao.Reproduzir: string;
begin
  Result := 'O Leão acabou de ter '+ Random(5).toString+ ' filhotes';
end;
