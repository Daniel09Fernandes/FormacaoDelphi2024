...
type
  ...
  private
    ...
    [JSONName('latlng')]
    FLatlngArray: TArray<Integer>;
    [JSONMarshalled(False)]
    FLatlng: TList<Integer>;
    FMaps: TMaps;
    FName: TName;
    FPopulation: Integer;
    ...
    function GetLatlng: TList<Integer>;
  ...
  published
    ...
    property Latlng: TList<Integer> read GetLatlng;
...
function TItems.GetLatlng: TList<Integer>;
begin
  Result := List<Integer>(FLatlng, FLatlngArray);
end;
...
begin
  ...
  RefreshArray<Integer>(FLatlng, FLatlngArray);
