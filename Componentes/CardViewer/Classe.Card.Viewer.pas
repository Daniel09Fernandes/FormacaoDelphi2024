...
begin
  ...
  begin
    if TFile.Exists('C:\Users\Gustavo Mena Barreto\OneDrive\햞ea de Trabalho\Componentes\Imagens\queenLOGO.jpg') then
    begin
      FImagemPrincipal.Picture.LoadFromFile('C:\Users\Gustavo Mena Barreto\OneDrive\햞ea de Trabalho\Componentes\Imagens\queenLOGO.jpg')
    end;
  end;
  ...
  if csDesigning in Self.ComponentState then
  begin
    if TFile.Exists('C:\Users\Gustavo Mena Barreto\OneDrive\햞ea de Trabalho\Componentes\Imagens\metallica.jpeg') then
    begin
      FImagemEsquerda.Picture.LoadFromFile('C:\Users\Gustavo Mena Barreto\OneDrive\햞ea de Trabalho\Componentes\Imagens\metallica.jpeg');
    end;
  end;
  ...
  if csDesigning in Self.ComponentState then
  begin
    if TFile.Exists('C:\Users\Gustavo Mena Barreto\OneDrive\햞ea de Trabalho\Componentes\Imagens\beatles.jpg') then
    begin
      FImagemDireita.Picture.LoadFromFile('C:\Users\Gustavo Mena Barreto\OneDrive\햞ea de Trabalho\Componentes\Imagens\beatles.jpg');
    end;
  end;
...
begin
  ...
  try
    ...
    st1.LoadFromFile('C:\Users\Gustavo Mena Barreto\OneDrive\햞ea de Trabalho\COMP3\Test-Token.txt');
    OAuth2Athenticator.AccessToken :=  st1.Text;
    st1.Free;

    RESTClient.Authenticator := OAuth2Athenticator;

    JSONBody.AddPair('providers', 'amazon');
...
begin
  ...
  try
    LoadImage(op.amazon.Items[0].Image, ImagemPrincipal.Picture);
    LoadImage(op.amazon.Items[1].Image, ImagemEsquerda.Picture);
    LoadImage(op.amazon.Items[2].Image, ImagemDireita.Picture);
  finally
    op.Free;
  end;
end;
